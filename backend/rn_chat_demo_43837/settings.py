"""
Django settings for rn_chat_demo_43837 project.
...
ROOT_URLCONF = 'rn_chat_demo_43837.urls'
...
WSGI_APPLICATION = 'rn_chat_demo_43837.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rn_chat_demo_43837 API",
    "DESCRIPTION": "API documentation for rn_chat_demo_43837 App",
    "VERSION": "v1",
}
